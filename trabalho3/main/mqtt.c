...
extern xSemaphoreHandle conexaoMQTTSemaphore, registerDeviceSemaphore;
char *room;
...
char* get_mac_address() {
    ...
    sprintf(formatted_address, "%x%x%x%x%x%x", mac_address[0], mac_address[1], mac_address[2], mac_address[3], mac_address[4], mac_address[5]);
